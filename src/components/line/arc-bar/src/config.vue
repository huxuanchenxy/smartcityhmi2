<template>
  <div class="setting-panel-gui">
    ...
    >
      ...
      >
        <g-input-number
          v-model="config.graphical.pieRadiusIn"
          :min="0"
          :max="100"
          :step="1"
          suffix="%"
      ...
      >
        <g-input-number
          v-model="config.graphical.pieRadiusOut"
          :min="0"
          :max="100"
          :step="1"
          suffix="%"
    ...
    >
      ...
      <g-field-collapse
        v-model="config.content.labelLine.show"
        :toggle="true"
        label="标题线"
      >
        <g-field
        ...
        >
          <g-color-picker
            v-model="config.content.labelLine.color"
          />
        </g-field>
        <g-field
          :level="2"
        ...
        >
          <g-input-number
            v-model="config.content.labelLine.width"
            :min="0"
            :max="100"
            :step="1"
          />
        ...
        >
          <g-select
            v-model="config.content.labelLine.type"
            :data="lineStyles"
          />
        </g-field>
      </g-field-collapse>
...
import { ArcBar,ArcBarSeries,colorItem } from './arc-bar'
