...
import { DynamicLine, DynamicLineSeries } from './dynamic-line'
...
export default defineComponent({
  ...
  setup(props) {
    ...
    let currentSeries:DynamicLineSeries = null

    const handleAddSeriesItem = () => {
      return new DynamicLineSeries('')
    }

    const openIcList = (item:DynamicLineSeries) => {
      currentSeries = item
