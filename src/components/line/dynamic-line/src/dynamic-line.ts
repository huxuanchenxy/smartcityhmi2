...
export class DynamicLineSeries extends DatavChartSeries {
 ...
 * DynamicLine
 */
export class DynamicLine extends DatavComponent {
  config = {
    global: {
