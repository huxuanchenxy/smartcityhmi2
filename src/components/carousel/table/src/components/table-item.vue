...
import { Table, TableSeries, defaultImg } from '../table'
...
export default defineComponent({
  ...
  props: {
    data: {
      type: Object as PropType<TableDto>,
      required: true,
    },
    tableWidth: {
      type: Number,
    ...
    globalConfig: {
      type: Object as PropType<Table['config']['global']>,
      required: true,
    },
    config: {
      type: Object as PropType<TableSeries>,
      required: true,
    },
  },
  setup(props) {
    const { isHighLight } = inject(tableInjectionKey)
