...
export class BasicAreaSeries extends DatavChartSeries {
 ...
 * BasicLine
 */
export class BasicArea extends DatavComponent {
    config = {
        global: {
