...
export class StackAreaSeries extends DatavChartSeries {
 ...
 * BasicLine
 */
export class StackArea extends DatavComponent {
  config = {
    global: {
  ...
  initData() {
    ...
    const series2 = new StackAreaSeries("");
    series2.line.color = "#79daff";
    series2.point.color = "#79daff";

    const series3 = new StackAreaSeries("");
    series3.line.color = "#0a73ff";
    series3.point.color = "#0a73ff";

    const series4 = new StackAreaSeries("");
    series4.line.color = "#3dabff";
    series4.point.color = "#3dabff";

    const series5 = new StackAreaSeries("");
