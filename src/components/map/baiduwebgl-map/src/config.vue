<template>
  <div class="setting-panel-gui">
    ...
    <g-field-collapse v-model="config.boundary.enable" label="行政区划" :toggle="true">
      <g-field
        label="行政区划名称"
        :level="2"
      >
        <g-input v-model="config.boundary.name" />
      </g-field>
      <g-field
        :level="2"
        label="折线颜色"
      >
        <g-color-picker
          v-model="config.boundary.strokeColor"
        />
      </g-field>
      <g-field
        label="折线宽度"
      ...
      >
        <g-input-number
          v-model="config.boundary.strokeWeight"
          :min="0"
          :max="100"
          :step="1"
        />
      ...
      >
        <g-input-number
          v-model="config.boundary.strokeOpacity"
          :min="0"
          :max="1"
          :step="0.1"
        />
      ...
      >
        <g-color-picker
          v-model="config.boundary.fillColor"
        />
      </g-field>
      <g-field
        label="填充透明度"
      ...
      >
        <g-input-number
          v-model="config.boundary.fillOpacity"
          :min="0"
          :max="1"
          :step="0.1"
        />
    ...
    <g-field-collapse v-model="config.mask.enable" label="掩膜" :toggle="true">
      <g-field
        label="行政区划名称"
        :level="2"
      >
        <g-input v-model="config.mask.name" />
      </g-field>
      <g-field
        :level="2"
        label="折线颜色"
      >
        <g-color-picker
          v-model="config.mask.strokeColor"
        />
      </g-field>
      <g-field
        label="折线宽度"
      ...
      >
        <g-input-number
          v-model="config.mask.strokeWeight"
          :min="0"
          :max="100"
          :step="1"
        />
      ...
      >
        <g-input-number
          v-model="config.mask.strokeOpacity"
          :min="0"
          :max="1"
          :step="0.1"
        />
      ...
      >
        <g-input-number
          v-model="config.mask.fillOpacity"
          :min="0"
          :max="1"
          :step="0.1"
        />
