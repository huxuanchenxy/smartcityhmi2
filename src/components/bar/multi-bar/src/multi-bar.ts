...
export class MultiBarSeries extends DatavChartSeries {
 ...
 * BasicLine
 */
export class MultiBar extends DatavComponent {
    config = {
        global: {
    ...
    initData() {
        ...
        const series2 = new MultiBarSeries('')
        series2.point.color = '#34FFF5'

        const series3 = new MultiBarSeries('')
        series3.point.color = '#79daff'

        const series4 = new MultiBarSeries('')
        series4.point.color = '#3dabff'

        const series5 = new MultiBarSeries('')
