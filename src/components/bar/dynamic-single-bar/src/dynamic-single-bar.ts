...
export class DynamicSingleSeries extends DatavChartSeries {
 ...
 * BasicBar
 */
export class DynamicSingleBar extends DatavEChartsComponent {
  config = {
    global: {
    ...
    series: [new DynamicSingleSeries('系列1')],
    animation: {
      enabled: true,
      duration: 1000,
      easing: 'cubicOut',
  ...
  constructor() {
    super('DynamicSingleBar', { w: 500, h: 300 })
...
export default DynamicSingleBar
