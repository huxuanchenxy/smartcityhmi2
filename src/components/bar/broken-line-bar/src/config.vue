<template>
  <div class="setting-panel-gui">
    ...
    >
      ...
      >
        <n-radio-group
          v-model:value="config.yAxisLeft.type"
          size="small"
        >
          <n-radio-button
      ...
      <g-field
        v-if="config.yAxisLeft.type === 'value'"
        :level="2"
        label="显示范围"
        :is-flat="true"
      >
        <g-select-suggest
          v-model="config.yAxisLeft.extent.min"
          :data="selectSuggests"
        ...
        />
        <g-select-suggest
          v-model="config.yAxisLeft.extent.max"
          :data="selectSuggests"
          :filters="['auto', 'dataMin', 'dataMax']"
          inline="inline"
          label="最大值"
      ...
      <g-field-collapse
        v-model="config.yAxisLeft.title.show"
        :toggle="true"
        label="轴标题"
      >
        <g-field
        ...
        >
          <g-input
            v-model="config.yAxisLeft.title.name"
          />
        </g-field>
        <g-field
          :level="2"
        ...
        >
          <g-select
            v-model="config.yAxisLeft.title.location"
            :data="titleLocations"
          />
        </g-field>
        <g-field
        ...
        >
          <g-input-number
            v-model="config.yAxisLeft.title.display.rotate"
            :min="0"
            :max="360"
            :step="1"
            suffix="度"
          ...
          />
          <g-input-number
            v-model="config.yAxisLeft.title.display.offset"
            :min="-1000"
            :max="1000"
            :step="1"
            suffix="px"
        ...
        >
          <g-input-number
            v-model="config.yAxisLeft.title.textStyle.fontSize"
            :min="12"
            :max="100"
            :step="1"
            suffix="px"
          ...
          />
          <g-color-picker
            v-model="config.yAxisLeft.title.textStyle.color"
            inline="inline"
            label="颜色"
          />
          <g-select
            v-model="config.yAxisLeft.title.textStyle.fontWeight"
            :data="fontWeights"
            inline="inline"
            label="字体粗细"
          />
      ...
      <g-field-collapse
        v-model="config.yAxisLeft.axisLine.show"
        :toggle="true"
        label="轴线"
      >
        <g-field
        ...
        >
          <g-select
            v-model="config.yAxisLeft.axisLine.type"
            :data="lineStyles"
          />
        </g-field>
        <g-field
        ...
        >
          <g-input-number
            v-model="config.yAxisLeft.axisLine.width"
            :min="0"
            :max="100"
            :step="1"
            suffix="px"
        ...
        >
          <g-color-picker
            v-model="config.yAxisLeft.axisLine.color"
          />
        </g-field>
      </g-field-collapse>
      <g-field-collapse
        v-model="config.yAxisLeft.axisTick.show"
        :toggle="true"
        label="轴刻度"
      >
        <g-field
        ...
        >
          <g-select
            v-model="config.yAxisLeft.axisTick.type"
            :data="lineStyles"
          />
        </g-field>
        <g-field
        ...
        >
          <g-input-number
            v-model="config.yAxisLeft.axisTick.width"
            :min="0"
            :max="100"
            :step="1"
            suffix="px"
        ...
        >
          <g-color-picker
            v-model="config.yAxisLeft.axisTick.color"
          />
        </g-field>
      </g-field-collapse>
      <g-field-collapse
        v-model="config.yAxisLeft.axisLabel.show"
        :toggle="true"
        label="轴标签"
      >
        <g-field
        ...
        >
          <g-select
            v-model="config.yAxisLeft.axisLabel.valueFormat"
            :data="valueFormats"
          />
        </g-field>
        <g-field
          v-if="config.yAxisLeft.type === 'time'"
          :level="2"
          tooltip="时间请参照 YYYY/MM/DD HH:mm:ss"
          label="显示格式"
        >
          <g-select
            v-model="config.yAxisLeft.axisLabel.timeFormat"
            :data="timeFormats"
          />
        </g-field>
        <g-field
        ...
        >
          <g-input-number
            v-model="config.yAxisLeft.axisLabel.boundaryGap"
            :min="0"
            :max="100"
            :step="1"
            suffix="%"
        ...
        >
          <g-input-number
            v-model="config.yAxisLeft.axisLabel.display.rotate"
            :min="0"
            :max="360"
            :step="1"
            suffix="度"
          ...
          />
          <g-input-number
            v-model="config.yAxisLeft.axisLabel.display.margin"
            :min="-1000"
            :max="1000"
            :step="1"
            suffix="px"
        ...
        >
          <g-select
            v-model="config.yAxisLeft.axisLabel.align"
            :data="hAligns"
          />
        </g-field>
        <g-field
        ...
        >
          <g-input-number
            v-model="config.yAxisLeft.axisLabel.textStyle.fontSize"
            :min="12"
            :max="100"
            :step="1"
            suffix="px"
          ...
          />
          <g-color-picker
            v-model="config.yAxisLeft.axisLabel.textStyle.color"
            inline="inline"
            label="颜色"
          />
          <g-select
            v-model="config.yAxisLeft.axisLabel.textStyle.fontWeight"
            :data="fontWeights"
            inline="inline"
            label="字体粗细"
          />
      ...
      <g-field-collapse
        v-model="config.yAxisLeft.grid.show"
        :toggle="true"
        label="网格线"
      >
        <g-field
        ...
        >
          <g-select
            v-model="config.yAxisLeft.grid.line.type"
            :data="lineStyles"
            inline="inline"
            label="类型"
          />
          <g-input-number
            v-model="config.yAxisLeft.grid.line.width"
            :min="0"
            :max="100"
            :step="1"
            suffix="px"
          ...
          />
          <g-color-picker
            v-model="config.yAxisLeft.grid.line.color"
            inline="inline-single"
            label="颜色"
          />
          <g-input-number
            v-if="config.yAxisLeft.grid.line.type === 'dashed'"
            v-model="config.yAxisLeft.grid.line.dashedLength"
            :min="0"
            :max="100"
            :step="1"
            suffix="px"
          ...
          <g-input-number
            v-if="config.yAxisLeft.grid.line.type === 'dashed'"
            v-model="config.yAxisLeft.grid.line.dashedSpace"
            :min="0"
            :max="100"
            :step="1"
            suffix="px"
    ...
    <g-field-collapse
      v-model="config.yAxisRight.show"
      :toggle="true"
      label="Y轴（右侧）"
    >
      <g-field
      ...
      >
        <n-radio-group
          v-model:value="config.yAxisRight.type"
          size="small"
        >
          <n-radio-button
            v-for="em in axisTypes"
      ...
      <g-field
        v-if="config.yAxisRight.type === 'value'"
        :level="2"
        label="显示范围"
        :is-flat="true"
      >
        <g-select-suggest
          v-model="config.yAxisRight.extent.min"
          :data="selectSuggests"
          :filters="['auto', 'dataMin', 'dataMax']"
          inline="inline"
          label="最小值"
        />
        <g-select-suggest
          v-model="config.yAxisRight.extent.max"
          :data="selectSuggests"
          :filters="['auto', 'dataMin', 'dataMax']"
          inline="inline"
          label="最大值"
      ...
      <g-field-collapse
        v-model="config.yAxisRight.title.show"
        :toggle="true"
        label="轴标题"
      >
        <g-field
        ...
        >
          <g-input
            v-model="config.yAxisRight.title.name"
          />
        </g-field>
        <g-field
          :level="2"
        ...
        >
          <g-select
            v-model="config.yAxisRight.title.location"
            :data="titleLocations"
          />
        </g-field>
        <g-field
        ...
        >
          <g-input-number
            v-model="config.yAxisRight.title.display.rotate"
            :min="0"
            :max="360"
            :step="1"
            suffix="度"
          ...
          />
          <g-input-number
            v-model="config.yAxisRight.title.display.offset"
            :min="-1000"
            :max="1000"
            :step="1"
            suffix="px"
        ...
        >
          <g-input-number
            v-model="config.yAxisRight.title.textStyle.fontSize"
            :min="12"
            :max="100"
            :step="1"
            suffix="px"
          ...
          />
          <g-color-picker
            v-model="config.yAxisRight.title.textStyle.color"
            inline="inline"
            label="颜色"
          />
          <g-select
            v-model="config.yAxisRight.title.textStyle.fontWeight"
            :data="fontWeights"
            inline="inline"
            label="字体粗细"
          />
      ...
      <g-field-collapse
        v-model="config.yAxisRight.axisLine.show"
        :toggle="true"
        label="轴线"
      >
        <g-field
        ...
        >
          <g-select
            v-model="config.yAxisRight.axisLine.type"
            :data="lineStyles"
          />
        </g-field>
        <g-field
        ...
        >
          <g-input-number
            v-model="config.yAxisRight.axisLine.width"
            :min="0"
            :max="100"
            :step="1"
            suffix="px"
        ...
        >
          <g-color-picker
            v-model="config.yAxisRight.axisLine.color"
          />
        </g-field>
      </g-field-collapse>
      <g-field-collapse
        v-model="config.yAxisRight.axisTick.show"
        :toggle="true"
        label="轴刻度"
      >
        <g-field
        ...
        >
          <g-select
            v-model="config.yAxisRight.axisTick.type"
            :data="lineStyles"
          />
        </g-field>
        <g-field
        ...
        >
          <g-input-number
            v-model="config.yAxisRight.axisTick.width"
            :min="0"
            :max="100"
            :step="1"
            suffix="px"
        ...
        >
          <g-color-picker
            v-model="config.yAxisRight.axisTick.color"
          />
        </g-field>
      </g-field-collapse>
      <g-field-collapse
        v-model="config.yAxisRight.axisLabel.show"
        :toggle="true"
        label="轴标签"
      >
        <g-field
        ...
        >
          <g-select
            v-model="config.yAxisRight.axisLabel.valueFormat"
            :data="valueFormats"
          />
        </g-field>
        <g-field
          v-if="config.yAxisRight.type === 'time'"
          :level="2"
          tooltip="时间请参照 YYYY/MM/DD HH:mm:ss"
          label="显示格式"
        >
          <g-select
            v-model="config.yAxisRight.axisLabel.timeFormat"
            :data="timeFormats"
          />
        </g-field>
        <g-field
        ...
        >
          <g-input-number
            v-model="config.yAxisRight.axisLabel.boundaryGap"
            :min="0"
            :max="100"
            :step="1"
            suffix="%"
        ...
        >
          <g-input-number
            v-model="config.yAxisRight.axisLabel.display.rotate"
            :min="0"
            :max="360"
            :step="1"
            suffix="度"
          ...
          />
          <g-input-number
            v-model="config.yAxisRight.axisLabel.display.margin"
            :min="-1000"
            :max="1000"
            :step="1"
            suffix="px"
        ...
        >
          <g-select
            v-model="config.yAxisRight.axisLabel.align"
            :data="hAligns"
          />
        </g-field>
        <g-field
        ...
        >
          <g-input-number
            v-model="config.yAxisRight.axisLabel.textStyle.fontSize"
            :min="12"
            :max="100"
            :step="1"
            suffix="px"
          ...
          />
          <g-color-picker
            v-model="config.yAxisRight.axisLabel.textStyle.color"
            inline="inline"
            label="颜色"
          />
          <g-select
            v-model="config.yAxisRight.axisLabel.textStyle.fontWeight"
            :data="fontWeights"
            inline="inline"
            label="字体粗细"
          />
      ...
      <g-field-collapse
        v-model="config.yAxisRight.grid.show"
        :toggle="true"
        label="网格线"
      >
        <g-field
        ...
        >
          <g-select
            v-model="config.yAxisRight.grid.line.type"
            :data="lineStyles"
            inline="inline"
            label="类型"
          />
          <g-input-number
            v-model="config.yAxisRight.grid.line.width"
            :min="0"
            :max="100"
            :step="1"
            suffix="px"
          ...
          />
          <g-color-picker
            v-model="config.yAxisRight.grid.line.color"
            inline="inline-single"
            label="颜色"
          />
          <g-input-number
            v-if="config.yAxisRight.grid.line.type === 'dashed'"
            v-model="config.yAxisRight.grid.line.dashedLength"
            :min="0"
            :max="100"
            :step="1"
            suffix="px"
          ...
          <g-input-number
            v-if="config.yAxisRight.grid.line.type === 'dashed'"
            v-model="config.yAxisRight.grid.line.dashedSpace"
            :min="0"
            :max="100"
            :step="1"
            suffix="px"
    ...
    >
      <template #default="slotProps">
        ...
        <g-field
          ...
          label="图形"
        >
          <n-select v-model:value="slotProps.item.type" size="small" :options="barTypeList" />
        </g-field>
        <g-field
          :level="2"
          label="区域样式"
...
import { BrokenLineBar, BrokenLineBarSeries, barType } from './broken-line-bar'

export default defineComponent({
  name: 'VBrokenLineBarProp',
  props: {
    com: {
  ...
  setup(props) {
    ...
    const handleAddSeriesItem = () => {
      return new BrokenLineBarSeries('')
    }

    const barTypeList = [ { label: '柱图', value : barType.bar }, { label: '折线图', value : barType.line }]
