...
export class LineBarSeries extends DatavChartSeries {
 ...
 * BasicLine
 */
export class LineBar extends DatavComponent {
    config = {
        global: {
    ...
    initData() {
        ...
        const series2 = new LineBarSeries('')
        series2.point.color = '#34FFF5'

        const series3 = new LineBarSeries('')
        series3.point.color = '#79daff'

        const series4 = new LineBarSeries('')
        series4.point.color = '#3dabff'

        const series5 = new LineBarSeries('')
