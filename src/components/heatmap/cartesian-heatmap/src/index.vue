...
import { CartesianHeatmap } from './cartesian-heatmap'
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const option = computed(() => {
      const { global, xAxis, yAxis, tooltip, legend, animation,visualMap } = config.value
      ...
      const opts = {
        ...
        visualMap: {
          ...
          max: visualMap.max,
          textStyle: {
            fontsize:visualMap.textStyle.fontSize,
            color: visualMap.textStyle.color,
            fontWeight: visualMap.textStyle.fontWeight
          },
          calculable:  visualMap.calculable,
          orient: visualMap.orient,
          top: visualMap.top,
          right: visualMap.right,
          inRange: {
            color: [visualMap.inRange.from, visualMap.inRange.middle, visualMap.inRange.to]
          }
        },
