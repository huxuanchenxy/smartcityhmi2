...
export class StackHorizontalSeries extends DatavChartSeries {
 ...
 * BasicLine
 */
export class StackHorizontal extends DatavComponent {
    config = {
        global: {
        ...
        series: [new StackHorizontalSeries('')],
        animation: {
            enabled: true,
            duration: 1000,
            easing: 'cubicOut',
    ...
    constructor() {
        super('StackHorizontal', { w: 500, h: 300 })
    ...
    initData() {
        ...
        const series2 = new StackHorizontalSeries('')
        series2.point.color = '#34FFF5'

        const series3 = new StackHorizontalSeries('')
        series3.point.color = '#79daff'

        const series4 = new StackHorizontalSeries('')
        series4.point.color = '#3dabff'

        const series5 = new StackHorizontalSeries('')
    ...
    async loadData() {
        try {
            ...
            const path = 'horizontal/stack-horizontal'
