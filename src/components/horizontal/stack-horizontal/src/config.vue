<template>
  <div class="setting-panel-gui">
    ...
    >
      ...
      >
        <n-switch
          v-model:value="config.yAxis.boundaryGap"
        />
      </g-field>
      <g-field-collapse
...
import { StackHorizontal, StackHorizontalSeries } from './stack-horizontal'

export default defineComponent({
  name: 'VStackHorizontalProp',
  props: {
    com: {
  ...
  setup(props) {
    ...
    const handleAddSeriesItem = () => {
      return new StackHorizontalSeries('')
    }
